...
void MatMul(const Matrix A, const Matrix B, Matrix C)
{
  ...
  // TODO: alocati matricea d_A pe device si puneti in ea date din matricea A de pe host
	cudaMalloc( (void**) &d_A.elements, size);    // the second parameter is the addres of the pointer, not the pointer itself
  ...
  // TODO: alocati matricea d_B pe device si puneti in ea date din matricea B de pe host
	cudaMalloc( (void**) &d_B.elements, size *sizeof(Matrix));    // the second parameter is the addres of the pointer, not the pointer itself
  ...
  // Invoke kernel, the widths are multiples of BLOCK_SIZEs
