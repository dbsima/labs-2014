...
CREATE TABLE edituri (
	ideditura	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE colectii (
	idcolectie	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
	denumire	VARCHAR(30) NOT NULL,
	descriere	VARCHAR(1000)
);

CREATE TABLE domenii (
	iddomeniu	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
	denumire	VARCHAR(30) NOT NULL,
	descriere	VARCHAR(1000)
);

CREATE TABLE carti (
	idcarte	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
	titlu		VARCHAR(50) NOT NULL,
	descriere	VARCHAR(1000),
	ideditura	INT(10) UNSIGNED NOT NULL,
	anaparitie	INT(4) NOT NULL,
	editie		INT(2) NOT NULL,
	idcolectie	INT(10) UNSIGNED NOT NULL,
	iddomeniu	INT(10) UNSIGNED NOT NULL,
	stoc		INT(4) UNSIGNED NOT NULL,
	pret		DECIMAL(8,2) UNSIGNED NOT NULL,
	FOREIGN KEY (ideditura) REFERENCES edituri(ideditura) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (idcolectie) REFERENCES colectii(idcolectie) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (iddomeniu) REFERENCES domenii(iddomeniu) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE scriitori (
	idscriitor	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE autori (
	idautor	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
	idcarte	INT(10) UNSIGNED NOT NULL,
	idscriitor	INT(10) UNSIGNED NOT NULL,
	FOREIGN KEY (idcarte) REFERENCES carti (idcarte) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (idscriitor) REFERENCES scriitori (idscriitor) ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE TABLE comenzi_aprovizionare (
	idcomandaaprovizionare	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
	serienumar					VARCHAR(10) NOT NULL,
...
CREATE TABLE detalii_comanda_aprovizionare (
	iddetaliucomandaaprovizionare	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
	idcomandaaprovizionare			INT(10) UNSIGNED NOT NULL,
	idcarte							INT(10) UNSIGNED NOT NULL,
	cantitate                           INT(4) UNSIGNED NOT NULL,
	FOREIGN KEY (idcomandaaprovizionare) REFERENCES comenzi_aprovizionare (idcomandaaprovizionare)  ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY (idcarte) REFERENCES carti (idcarte)  ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE detalii_factura (
	iddetaliufactura	INT(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
INSERT INTO domenii (denumire, descriere)
 VALUES('Criminalistica', '-');
INSERT INTO carti (titlu, descriere, ideditura, anaparitie, editie, idcolectie, iddomeniu, stoc, pret)
...
INSERT INTO scriitori (nume, prenume, biografie)
 VALUES('NABOKOV', 'Angelo', '-');
INSERT INTO autori (idcarte, idscriitor)
 VALUES('20', '23');
INSERT INTO autori (idcarte, idscriitor)
 VALUES('39', '66');
INSERT INTO autori (idcarte, idscriitor)
...
INSERT INTO autori (idcarte, idscriitor)
 VALUES('88', '69');
INSERT INTO comenzi_aprovizionare (serienumar, data, stare, ideditura)
...
INSERT INTO detalii_comanda_aprovizionare (idcomandaaprovizionare, idcarte, cantitate)
 VALUES('20', '23', '9');
INSERT INTO detalii_comanda_aprovizionare (idcomandaaprovizionare, idcarte, cantitate)
 VALUES('66', '79', '10');
INSERT INTO detalii_comanda_aprovizionare (idcomandaaprovizionare, idcarte, cantitate)
...
INSERT INTO detalii_comanda_aprovizionare (idcomandaaprovizionare, idcarte, cantitate)
 VALUES('9', '62', '8');
INSERT INTO utilizatori (CNP, nume, prenume, adresa, telefon, email, tip, rol, numeutilizator, parola)
...
INSERT INTO facturi (serienumar, data, stare, CNP)
...
INSERT INTO detalii_factura (idfactura, idcarte, cantitate)
 VALUES('20', '23', '9');
INSERT INTO detalii_factura (idfactura, idcarte, cantitate)
 VALUES('66', '79', '10');
INSERT INTO detalii_factura (idfactura, idcarte, cantitate)
