<?php
	define('STUDENT_ID',126); // put your student id from http://pw.dictionarit.eu/tema02-student-list.php here
	define('URL_TEMA2','http://localhost/hw2/'); // put the link to your homework here
		...
		1 => array(
			...
			'subtasks' => array(
				...
				3 => array(
					...
					'description' => 'Should print the same result as '.getHtmlLink(URL_CHECKER.'/show-entries.php?student='.STUDENT_ID.'&table=pw_user'),
					'score' => 0.01,
				),
				4 => array(
					'name' => 'Request show-entries.php with <i>pw_article</i> for <i>table</i> GET parameter',
					'description' => 'Should print the same result as '.getHtmlLink(URL_CHECKER.'/show-entries.php?student='.STUDENT_ID.'&table=pw_article'),
					'score' => 0.01,
				),
				5 => array(
					'name' => 'Request show-entries.php with <i>pw_category</i> for <i>table</i> GET parameter',
					'description' => 'Should print the same result as '.getHtmlLink(URL_CHECKER.'/show-entries.php?student='.STUDENT_ID.'&table=pw_category'),
					'score' => 0.01,
				),
				6 => array(
					'name' => 'Request show-entries.php with <i>pw_article_category</i> for <i>table</i> GET parameter',
					'description' => 'Should print the same result as '.getHtmlLink(URL_CHECKER.'/show-entries.php?student='.STUDENT_ID.'&table=pw_article_category'),
					'score' => 0.01,
				),
			),
		),
